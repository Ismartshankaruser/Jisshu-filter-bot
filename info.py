...
BOT_TOKEN = environ.get("BOT_TOKEN", "mongodb+srv://Manjappa:22996@cluster0.bqhplqi.mongodb.net/?appName=Cluster0")
PORT = environ.get("PORT", "8082")

# Owners
ADMINS = [
    int(admin) if id_pattern.search(admin) else admin
    for admin in environ.get("ADMINS", "5000162773").split()
]
OWNER_USERNAME = environ.get(
    "OWNER_USERNAME", "KingKishan"
)  # without @ or https://t.me/
USERNAME = environ.get("USERNAME", "KingKishan")  # ADMIN USERNAME

# Database Channel
CHANNELS = [
    int(ch) if id_pattern.search(ch) else ch
    for ch in environ.get("CHANNELS", "-1003622614396").split()
]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1003928657783"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1003928657783"))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1003888732490"))
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", "-1004297605499"))
LOG_VR_CHANNEL = int(environ.get("LOG_VR_CHANNEL", "-1003823902223"))

# MongoDB
DATABASE_URI = environ.get("DATABASE_URI", "mongodb+srv://Manjappa:22996@cluster0.bqhplqi.mongodb.net/?appName=Cluster0")
...
# Other Channel's
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1003449452691"))
DELETE_CHANNELS = int(environ.get("DELETE_CHANNELS", "-1003994033962"))
request_channel = environ.get("REQUEST_CHANNEL", "-1003928657783")
REQUEST_CHANNEL = (
    int(request_channel)
    if request_channel and id_pattern.search(request_channel)
    else None
)
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1003911377505"))

# Added Link Here Not Id
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "https://t.me/+igMhuEruFIlhNDJl")
MOVIE_GROUP_LINK = environ.get("MOVIE_GROUP_LINK", "https://t.me/+igMhuEruFIlhNDJl")

# Verification
IS_VERIFY = is_enabled("IS_VERIFY", False)
# ---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/EpicCastle/8")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/EpicCastle/5")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/EpicCastle/3")
